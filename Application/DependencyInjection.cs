...
namespace Application
{
    public static class DependencyInjection
    {
        public static void AddApplication(this IServiceCollection services)
        {
            ...
            services.AddTransient<IValidator<CreateColaCommand>, CreateColaCommandValidator>();
            services.AddTransient<IValidator<UpdateColaCommand>, UpdateColaCommandValidator>();

            services.AddTransient<IValidator<CreateTicketCommand>, CreateTicketCommandValidator>();
